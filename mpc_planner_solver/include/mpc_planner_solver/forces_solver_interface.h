#ifndef __MPC_PLANNER_SOLVER_FORCES_H__
#define __MPC_PLANNER_SOLVER_FORCES_H__

// FORCES Pro solver is not used when ACADOS_SOLVER is defined
#ifndef ACADOS_SOLVER
...
#endif // __MPC_PLANNER_SOLVER_FORCES_H__